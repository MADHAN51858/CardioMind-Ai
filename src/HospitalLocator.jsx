    ...
    <Box className="animate-fade-in" sx={{ width: "100%", pb: 4 }}>
      ...
      <Box sx={{ mb: 2.5 }}>
        <Typography variant="h4" sx={{ fontWeight: 800, mb: 0.5, display: "flex", alignItems: "center", gap: 1.5 }}>
          ...
          Cardiology Hospital Locator
        </Typography>
        <Typography variant="body1" color="text.secondary">
          Find nearby specialized heart care centers, calculate emergency travel routes.
        </Typography>
      </Box>

      {/* Location Search Bar & Controls */}
      <Card sx={{ p: 2, mb: 2.5, bgcolor: "transparent", borderRadius: "12px",border:"2px solid #d1d1d1ff", boxShadow: "none"}}>
            ...
            <Box sx={{ p: 2.5, flex: 1 }}>
              ...
              <Box sx={{ mb: 3 }}>
                ...
                {loadingRoutes ? (
                  ...
                  <Paper variant="outlined" sx={{ p: 2, borderRadius: "12ppx" }}>
                    <Tabs
                      value={routeMode}
                    ...
                    {doctorsData.doctors.map((doc, idx) => (
                      <Paper
                        ...
                        sx={{
                          ...
                          "&:hover": { borderColor: "primary.main", boxShadow: "0 4px 12px rgba(59, 130, 246, 0.08)" },
                        }}
                      >
